  ...
  render() {
    return (
      <div className = "gameDiv">
        <div>
          <canvas ref = "canvas" id = "gameCanvas" width = {(this.state.numX) * this.state.cellSeize + 1} height = {this.state.numY * this.state.cellSize + 1} onClick = {this.canvasOnClick} />
        </div>
        <div>
